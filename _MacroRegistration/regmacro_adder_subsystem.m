function sam = regmacro_adder_subsystem
%REGMACRO_???
% Registration of ??? macro in SimAssist

sam = saMacro('adder_subsystem');
sam.Pattern = '^(ss|subsys|subsystem)';
sam.Callback = @adder_subsystem;

end



function [actrec, success] =adder_subsystem(cmdstr, console)
